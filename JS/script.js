...
//////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  var tbodyElt = document.querySelector('tbody'); //on récupére le contenu du tableau dans le DOC
...
////////////////////////////////////////////////////////////////////////////////////////////////
  var divajout = document.getElementById('ajout');  //on récupére l'espace préétablit en HTML
  var btnAdd = document.createElement('button');    // on créer un bouton
  divajout.appendChild(btnAdd);                     //on apparent l'espace au bouton créé
  btnAdd.className="btn btn-primary"                //on change la couleur du bouton
  btnAdd.textContent ='Ajouter';                    //on intégre un texte à l'interieur du bouton
//////////////////////////////////FIN EVENEMENT////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////
  btnAdd.addEventListener ('click', function(){  //on assigne un événement au clique du bouton
    var form = document.createElement('form');   //on créer un formulaire

    var inpt = document.createElement('input');  // on crée un input pour le titre
    inpt.placeholder ="Titre";
    inpt.required ='required';                   //on oblige l'utilisateur à remplir l'input

    var inpt2 = document.createElement('input'); // on crée un input pour la date
    inpt2.placeholder ="Date";
    inpt2.required ='required';                  //on oblige l'utilisateur à remplir l'input
    // inpt2.!^((?:19|20)\d{2})$!

    var inpt3 = document.createElement('input'); // on crée un input pour le réalisateur
    inpt3.placeholder ="Realisateur";
    inpt3.required ='required';                  //on oblige l'utilisateur à remplir l'input

    var inpt4 = document.createElement('input'); //on créé un bouton d'envoi de formulaire
    inpt4.type ='submit';

    inpt4.className="btn btn-primary"            //on change la couleur du bouton d'envoi
    form.appendChild(inpt);                      //on apparente inpt au formulaire
    form.appendChild(inpt2);                     //on apparente  inpt2 au formulaire
    form.appendChild(inpt3);                     //on apparente  inpt3 au formulaire
    form.appendChild(inpt4);                     //on apparente  inpt4 au formulaire
...
function afficher(){  //fonction d'intégration des éléments du tableau listeFIlms dans la page HTML
  ...
  for (var film of listeFilms) {
    ...
    trElt = document.createElement('tr');       //Cree une ligne
    tdEltTitre = document.createElement('td');  //cree une cellule pour le Titre
    tdEltTitre.textContent = film.titre;        //recupere les valeurs de la liste pour les affecter dans les cellules correspondantes
    tdEltAnnee = document.createElement('td');  //cree une cellule pour l'annee
    tdEltAnnee.textContent = film.annee;        //recupere les valeurs de la liste pour les affecter dans les cellules correspondantes
    tdEltReal = document.createElement('td');    //cree une cellule pour le realisateur
    ...
    tdEltSuppr = document.createElement('td');  //Creation d'une cellule pour le bouton supprimer

    btnSuppr = document.createElement('button');//création du bouton supprimer
    ...
    i++;                                        //on incrémente
    tdEltSuppr.appendChild(btnSuppr)            //on apparente le bouton supprimer à sa cellule
...
////////////////////////////////////////////////////////////////////////////////////////////
  function alertAjout(texte,classe){
    ...
    pInfo.textContent= "votre film a été ajouté";
...
////////////////////////////////////////////////////////////////////////////////////////////
   function alertSuppr(texte,classe){
    ...
    pSuppr.textContent= "votre film a été supprimé";
